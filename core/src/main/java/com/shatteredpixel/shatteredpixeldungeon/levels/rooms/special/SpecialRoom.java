...
public abstract class SpecialRoom extends Room {
	...
	private static final ArrayList<Class<? extends SpecialRoom>> EQUIP_SPECIALS = new ArrayList<>( Arrays.asList(
			...
			StatueRoom.class, StatueRoom.class, StatueRoom.class, StatueRoom.class, StatueRoom.class,
			StatueRoom.class, StatueRoom.class, StatueRoom.class, StatueRoom.class, StatueRoom.class,
			StatueRoom.class, StatueRoom.class, StatueRoom.class, StatueRoom.class, StatueRoom.class,
			CrystalVaultRoom.class, CrystalChoiceRoom.class, SacrificeRoom.class
	));

...
public class MeleeWeapon extends Weapon {
	...
	public String info() {
		...
		if (levelKnown) {
			info += "\n\n" + Messages.get(MeleeWeapon.class, "stats_known", grade, augment.damageFactor(min()), augment.damageFactor(max()), STRReq());
			...
			info += "\n\n" + Messages.get(MeleeWeapon.class, "stats_unknown", grade, min(0), max(0), STRReq(0));
